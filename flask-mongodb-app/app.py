...
# If not found, it defaults to 'mongodb://admin:sapana@mongo-service:27017/'
client = MongoClient(os.environ.get("MONGODB_URI", "mongodb://admin:sapana@mongo-service:27017/"))
